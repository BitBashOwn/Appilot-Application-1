...
public class OpenAIClient {
    ...
    public void generateCommentForRetweet(String originalComment, int promptNum, String promptText, OpenAICallback callback) {
        if (promptNum == 1) {
            // Create the prompt for generating a relevant comment
            prompt ="You are a witty, engaging Twitter user who replies naturally to tweets. " +
                    "Read the original tweet carefully: \"" + originalComment + "\". " +
                    "The user has provided guidance for the style, tone, or type of comment: \"" + promptText + "\". " +
                    "Do NOT treat the guidance as content to respond to directly; use it only to shape the tone and style of your reply. " +
                    "Include any safe hashtags or mentions exactly as provided in the guidance. " +
                    "Write a short, authentic, friendly, and human-like comment. " +
                    "Keep it concise (max 280 characters, ideally 50–120). " +
                    "Match the tone suggested by the guidance — if it’s funny, be witty; if serious, be thoughtful. " +
                    "Avoid emojis unless they fit naturally, and never generate harmful or offensive content.";
//        } else if (promptNum == 2) {
//            prompt = "You are crafting a natural and engaging quote tweet for a repost. " +
//                    "Read the original tweet carefully and write a short (50–100 characters) quote that feels authentic, conversational, and relevant to its message. " +
//                    "Match the tone of the tweet — if it’s funny, reply with wit; if it’s inspiring, echo positivity; if it’s newsy, react thoughtfully. " +
